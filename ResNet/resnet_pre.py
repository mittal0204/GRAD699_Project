...
parser.add_argument("--zoom", help='zoom_level',default=100)
...
data_train = torchvision.datasets.ImageFolder("../Kaggle_Data/test/{}".format(zoom_level_x), transform=transform)
print(data_train)
data_test = torchvision.datasets.ImageFolder("../Kaggle_Data/train/{}".format(zoom_level_x), transform=transform)
print(data_test)
...
features = list(resnet_based.fc.children())[:-1] # Remove last layer
# print(type(resnet_based.classifier.children()))
features.extend([torch.nn.Linear(512, 2)])
resnet_based.fc = torch.nn.Sequential(*features)
...
# sftp://test1@10.107.42.42/home/Drive2/amil/res_net_pretrained
